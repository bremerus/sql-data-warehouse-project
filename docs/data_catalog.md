...
## Overview
This gold layer is built to provide business-ready data for analysis. It contains dimensional tables and fact tables.

---

### 1. **gold.dim_customers**
  - **Purpose:** Provides all the useful reachable data for the customers.
  - **Columns:**
...
| customer_number | NVARCHAR(50) | A unique key, basically AW000 + customer_id (e.g., AW00011001). |
...
### 2. **gold.dim_products**
  - **Purpose:** Provides all the useful reachable data for products.
  - **Columns:**

| Column Name | Data Type | Description |
| :--- | :--- | :--- |
| product_key | INT | A unique key for each product in this table. |
| product_id | INT | A unique key that allows us to join gold.fact_sales via this key. |
...
### 3. **gold.fact_sales**
  - **Purpose:** Provides all the useful reachable data for sales.
  - **Columns:**
